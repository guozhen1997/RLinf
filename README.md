...
## What's NEW!
- [2026/07] 🔥 RLinf supports RLT for simulation and real-robot online RL fine-tuning of VLA policies. Doc: [RLT](https://rlinf.readthedocs.io/en/latest/rst_source/examples/embodied/rlt.html).
