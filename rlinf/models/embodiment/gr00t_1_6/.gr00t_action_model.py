...
import numpy as np
import torch
from gr00t.data.type import ModalityConfig
...
from gr00t.model.gr00t_n1d6 import gr00t_n1d6 #
...
class FlowMatchingActionHeadForRLActionPrediction(FlowmatchingActionHead):
    def __init__(
        ...
        ## modify for n1.6
        modality_config: Optional[dict[str, ModalityConfig]] = None,
        modality_transform: Optional["ComposedModalityTransform"] = None,
...
class GR00T_N1_6_ForRLActionPrediction(gr00t_n1d6, BasePolicy):
    """
    GR00T_N1_6 model for reinforcement learning action prediction.
    It's a combination of the Gr00tPolicy and GR00T_N1_6 model.
    ...
    def __init__(
        ...
        if modality_config is None or modality_transform is None:
            ...
            modality_transform = getattr(temp_policy, "_modality_transform", None) \
                              or getattr(temp_policy, "modality_transform", None)
            if modality_transform is None:
                raise AttributeError("Not find _modality_transform, please run print(dir(temp_policy)) and tell me what property you have")
